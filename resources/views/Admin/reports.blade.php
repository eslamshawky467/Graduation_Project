...
<div class="col-xl-12 mb-30">
    <div class="card card-statistics h-100">
        ...
        @endif
            ...
            <form method="post" action="{{ route('reports.bulk_delete') }}" style="display: inline-block;">
                @csrf
                @method('delete')
            ...
            <div class="table-responsive">
                <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
                    ...
                    <tbody>
                        ...
                        <tr id="sid{{ $report->id}}">
                            <td><input type="checkbox" name="ids[{{ $report->id }}]" class="checkbox" value="{{ $report->id }}"/></td>
                                <td></td>
                                <td></td>
                                <td></td>
                                <td></td>
   ...
   <div class="modal-dialog" role="document">
       <div class="modal-content">
           ...
           <div class="modal-body">
               <form action="{{ route('reports.destroy', 'test') }}"
                     method="post">
                   {{ method_field('Delete') }}
                   @csrf
                   <input id="id" type="hidden" name="id" class="form-control"
                          value="{{ $report->id }}">هل تريد حذف هذا التقرير؟
